...
if height.upper() == "A" and entrants['six']<3:
    entrants['six'] += 1
    print("Welcome")
elif height.upper() == "B" and entrants['fivepoint']<2:
    entrants['fivepoint'] += 1
    print("Welcome")
elif height.upper() == "D" and entrants['four']<2:
    entrants['four'] += 1
    print("Welcome")
else:
    print("No space for people your height")
